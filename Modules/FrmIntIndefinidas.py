...
class frm_integral_indefinida(Frame):
    def __init__(self, root=  None):
        super().__init__(root,width=100,height=100,background="white", padx=10, pady=2)
        self.root=root
        self.pack()
        self.crear_widget()
    ...
    def resultado(self):
        try:
            if(self.funcion_entry.get()!= ""):
                self.resultado_entry.delete(0, END)
                self.resultado_entry.insert(END, integrate(self.funcion_entry.get()))
    ...
    def crear_widget(self):
        ...
        self.funcion_entry = Entry(self, relief="solid", justify='center', font="Arial 13", width=35)
        self.funcion_entry.grid(row=1, column=0, columnspan=6, ipady=10)
        self.funcion_entry.focus()
        ...
        self.resultado_entry = Entry(self, relief="solid", justify='center', font="Arial 13", width=35)
        self.resultado_entry.grid(row=3, column=0, columnspan=6, ipady=10, pady=10)
        ...
        self.abrir_parentesis_btn=Button(self, text="(", width=7, height=2, relief="solid", background ="#377DFF", command=lambda:self.setFuction("("))
        self.abrir_parentesis_btn.grid(row=5, column=3)

        self.cerrar_parentesis_btn=Button(self, text=")", width=7, height=2, relief="solid", background ="#377DFF", command=lambda:self.setFuction(")"))
        self.cerrar_parentesis_btn.grid(row=5, column=4)

        self.potencia_btn=Button(self, text="x^", width=7, height=2, relief="solid", background ="#377DFF", command=lambda:self.setFuction("**"))
        self.potencia_btn.grid(row=6, column=3)

        self.raiz_btn=Button(self, text="√", width=7, height=2, relief="solid", background ="#377DFF", command=lambda:self.setFuction("sqrt("))
